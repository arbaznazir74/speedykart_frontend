...
export default function BannersPage() {
  const crud = useCrud<Banner>({ endpoint: API_ENDPOINTS.BANNER });
  return (
    <CrudPage title="Banners" description="Manage promotional banners (shared across HotBox & SpeedyMart)" columns={columns} formFields={formFields}
      ...
      onCreate={async (d) => { await crud.create(d as Partial<Banner>); }}
      onUpdate={async (d) => { await crud.update(d as Partial<Banner>); }}
