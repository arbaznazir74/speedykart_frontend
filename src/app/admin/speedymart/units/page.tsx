...
export default function SpeedyMartUnitsPage() {
  ...
  const formFields: FormField[] = [
    { key: "name", label: "Unit Name", required: true, placeholder: "e.g. Kilogram, Liter" },
    { key: "shortCode", label: "Short Code", required: true, placeholder: "e.g. kg, ml" },
  ...
  return (
    <CrudPage title="SpeedyMart Units" description="Manage measurement units for grocery items (kg, ml, etc.)" columns={columns} formFields={formFields}
