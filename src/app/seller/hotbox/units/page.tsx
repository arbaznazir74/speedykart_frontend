...
export default function SellerHotBoxUnitsPage() {
  const { user } = useAuth();
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="HotBox Units" description="Manage your units. Admin-created units are available to all sellers.">
